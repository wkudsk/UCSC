#!/usr/bin/perl
# $Id: haversine.perl,v 1.7 2018-02-28 16:40:07-08 - - $
...
while (<DATABASE>) {
   ...
   my ($airport, $name, $nlatdeg, $nlatmin, $wlondeg, $wlonmin)
         = ($1, $2, $3, $4, $5, $6);
   $airport = uc $airport;
   $database{$airport} = [$name, $nlatdeg, $nlatmin,
                                 $wlondeg, $wlonmin];
}
close DATABASE;
